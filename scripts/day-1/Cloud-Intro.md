...
**Cost**
    - Cost to entry: small startup costs, whihc allow smaller companies to utilise cloud computing and its benefits (don't need to buy/maintain 
...
| Availability | If hardware fails,      | High availability (HA)| 
|              | VM is down              |  & redundancy options |
